...
Java_com_example_androidndk_CameraActivity_createCamera(JNIEnv *env,
                                                        jobject instance,
                                                        jint width, jint height) {
    pEngineObj = new CameraAppEngine(env, instance, width, height);
    return reinterpret_cast<jlong>(pEngineObj); // 강제로 Long타입으로 변환 후 return
}
...
Java_com_example_androidndk_CameraActivity_deleteCamera(JNIEnv *env,
                                                        jobject instance,
                                                        jlong ndkCameraObj) {
...
Java_com_example_androidndk_CameraActivity_getMinimumCompatiblePreviewSize(
...
Java_com_example_androidndk_CameraActivity_getCameraSensorOrientation(
        JNIEnv *env, jobject instance, jlong ndkCameraObj) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_example_androidndk_CameraActivity_onPreviewSurfaceCreated(
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_example_androidndk_CameraActivity_onPreviewSurfaceDestroyed(
        JNIEnv *env, jobject instance, jlong ndkCameraObj, jobject surface) {
    CameraAppEngine *pApp = reinterpret_cast<CameraAppEngine *>(ndkCameraObj);
